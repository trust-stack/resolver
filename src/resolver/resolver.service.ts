...
import {normalisePath, validatePath} from "../link/link.utils.ts";
import {LinksetResponseDto, ResolverQueryDto} from "./resolver.dto.ts";
...
export class ResolverService {
  constructor(private readonly db: DB, private readonly baseUrl: string = DEFAULT_BASE_URL) {}
